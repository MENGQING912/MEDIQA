...
from lavis.datasets.datasets.minigpt4_instructions import InstructionDataset,ChallengeDataset
...
@registry.register_builder("challenge")
class ChallengeBuilder(BaseDatasetBuilder):
    eval_dataset_cls = ChallengeDataset
    DATASET_CONFIG_DICT = {
        'default': 'configs/datasets/challenge/defaults_instruction.yaml'
    }